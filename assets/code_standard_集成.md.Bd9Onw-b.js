import{_ as a,c as n,o as e,ae as p}from"./chunks/framework.Dwd5JCA7.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"code_standard/集成.md","filePath":"code_standard/集成.md","lastUpdated":1757602575000}'),t={name:"code_standard/集成.md"};function l(i,s,o,c,r,d){return e(),n("div",null,[...s[0]||(s[0]=[p(`<h2 id="prettier-和-eslint集成配置方案" tabindex="-1">Prettier 和 ESLint集成配置方案 <a class="header-anchor" href="#prettier-和-eslint集成配置方案" aria-label="Permalink to &quot;Prettier 和 ESLint集成配置方案&quot;">​</a></h2><ol><li>安装依赖</li></ol><ul><li>npm install --save-dev eslint prettier eslint-config-prettier eslint-plugin-prettier</li></ul><ol start="2"><li>配置文件<code>‌.eslintrc.js</code></li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>module.exports = {</span></span>
