import{_ as a,c as n,o as e,ae as p}from"./chunks/framework.Dwd5JCA7.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/typescript/类.md","filePath":"docs/typescript/类.md","lastUpdated":1758337320000}'),t={name:"docs/typescript/类.md"};function i(l,s,c,o,r,d){return e(),n("div",null,[...s[0]||(s[0]=[p(`<h2 id="类" tabindex="-1">类 <a class="header-anchor" href="#类" aria-label="Permalink to &quot;类&quot;">​</a></h2><ul><li>相同属性和方法的一系列对象的集合，用<code>class</code>关键字定义</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span> class Person{</span></span>
